...
/**
 * Created by Ultra on 30/11/2017.
 */

public class Uploader extends AsyncTask<String, Void, String> {

    private Exception exception;
    public static final String URL_UPLOAD = "<URL-TO-YOUR-UPLOAD-SERVER>";
    ...
    protected String doInBackground(String... urls) {
        ...
        String result = multipartRequest(URL_UPLOAD, params, urls[0], "file", "image/jpeg");
        return result;
